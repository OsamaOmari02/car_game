...
def description_popup_util():
    ...
    # Define the text and its line breaks
    text_lines = [
        "Move away from the cars to gain score!",
        "Use the right arrow to move to the right side.",
        "Use the left arrow to move to the left side.",
        "The more you gain score, the more the game gets harder."
    ]

    # Background color and border
    background_color = (240, 240, 240, 220)  # Light gray with transparency
    ...
    ok_button_rect = ok_button.get_rect(center=(popup_width // 2, popup_height - button_height // 2 - 20))
